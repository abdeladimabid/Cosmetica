...
public class ApiSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests().antMatchers("/COSMETICA/brand/**").hasAnyAuthority("superadmin","user").and()
		.authorizeRequests().antMatchers("/COSMETICA/cart/**").hasAnyAuthority("superadmin","user").and()
		.authorizeRequests().antMatchers("/COSMETICA/category/**").hasAnyAuthority("superadmin","user").and()
		.authorizeRequests().antMatchers("/COSMETICA/client/**").hasAnyAuthority("superadmin","user").and()
		.authorizeRequests().antMatchers("/COSMETICA/coupon/**").hasAnyAuthority("superadmin").and()
		.authorizeRequests().antMatchers("/COSMETICA/image/**").hasAnyAuthority("superadmin").and()
		.authorizeRequests().antMatchers("/COSMETICA/order/**").hasAnyAuthority("superadmin").and()
		.authorizeRequests().antMatchers("/COSMETICA/product/**").hasAnyAuthority("superadmin","user").and()
		.authorizeRequests().antMatchers("/COSMETICA/review/**").hasAnyAuthority("superadmin","supervisor").and()
		...
		.authorizeRequests().antMatchers("/COSMETICA/user/**").hasAnyAuthority("superadmin").and()
